...
function estaoSobrepostos (elementoA, elementoB) {
    const a = elementoA.getBoundingClientRect() //Pega retangulo relacionado ao elemento A
    const b = elementoB.getBoundingClientRect() //Pega retangulo relacionado ao elemento B
